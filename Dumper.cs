...
namespace ObjectDumper
{
    ...
    public static class Dumper
    {
        ...
        /// </exception>
        public static void Dump(object value, string name, TextWriter writer) => Dump(value, name, writer, DumpOptions.Default);
        ...
        private static void InternalDump(int indentationLevel, string name, object value, TextWriter writer, ObjectIDGenerator idGenerator,bool recursiveDump, DumpOptions options)
        {
            ...
            if (!type.IsValueType)
            {
                long key = idGenerator.GetId(value, out bool firstTime);
                if (!firstTime)
