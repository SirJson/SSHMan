...
namespace ObjectDumper
{
    ...
    public static class ObjectDumperExtensions
    {
        ...
        /// </exception>
        public static T Dump<T>(this T value, string name, TextWriter writer) => Dump(value, name, writer, DumpOptions.Default);
        ...
        /// <para><paramref name="name"/> is <c>null</c> or empty.</para>
        /// </exception>
        public static string DumpToString<T>(this T value, string name) => DumpToString(value, name, DumpOptions.Default);
        ...
        public static string DumpToString<T>(this T value, string name, DumpOptions options)
        {
            ...
            _ = Dump(value, name, writer, options);
